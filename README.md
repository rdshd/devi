...
<head>
  ...
  <style>
    ...
    .page {
      max-width: 980px;
      margin: 2.5cm auto 2cm auto;
      background: #fff;
      padding: 3.5rem 2.4rem 2.4rem 2.4rem;
      border-radius: 28px;
      box-shadow: 0 0 36px 0 rgba(25,31,58,.09);
      position: relative;
    }
    .header-image {
      width: 100%;
      ...
      border-radius: 22px;
      margin-bottom: 1.7em;
      box-shadow: 0 8px 32px 0 rgba(76,124,246,0.08);
      background: url('file:///home/ppap/Downloads/ChatGPT%20Image%20Jul%2021,%202025,%2012_05_33%20PM.png') center center/cover no-repeat;
    }
    h1, h2 {
      font-family: 'Vazirmatn', Tahoma, sans-serif;
      line-height: 1.28;
    ...
    h1 {
      ...
      margin-bottom: 1.2em;
      text-align: center;
      background: linear-gradient(92deg,#22d3ee,#6366f1 70%);
    ...
    h2 {
      ...
      margin-top: 2.5em;
      margin-bottom: 1em;
      border-right: 5px solid #2471f7;
      padding-right: 0.7em;
      border-radius: 12px;
      display: inline-block;
      background: linear-gradient(90deg, #e0e7ff 0%, #fff 85%);
      box-shadow: 0 2px 12px #e7e7e7a8;
    }
    h3 {
      font-size: 1.09rem;
      color: #3b4863;
    ...
    .team-photo {
      ...
      border-radius: 19px;
      margin: 0 auto;
      box-shadow: 0 8px 28px 0 rgba(36,113,247,0.11);
      margin-bottom: 2em;
      display: block;
    }
    .service-list {
    ...
    .contact-box {
      background: linear-gradient(99deg, #e0ecff 40%, #f8fafc 120%);
      border-radius: 14px;
      padding: 1.5em 1.3em;
      margin-top: 2em;
      box-shadow: 0 1px 6px #d2e2fa4c;
      text-align: center;
    }
    .contact-icons {
      margin-top: 1em;
    ...
    .contact-icons a:hover { color: #00bcd4; }
    .footer {
      text-align: center;
      color: #94a3b8;
      font-size: 1em;
    ...
    @media (max-width: 800px) {
      .page { padding: 2.2rem 0.5rem; }
      .service-list { flex-direction: column; gap: 13px; }
    }
    @media print {
      body { background: none; }
      .page { box-shadow: none; border-radius: 0; margin: 0; padding: 0.9cm 1.5cm; max-width: none; }
      .footer { display: none; }
      a { color: #1a3eab !important; text-decoration: underline; }
    }
  </style>
  <!-- برای آیکون‌ها -->
